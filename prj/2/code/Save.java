...
abstract class Save {
	...
	public static void setDefaultKey(Encrypt e, String fileLocation) {
		File defaultKey = new File(fileLocation + System.getProperty("file.separator") + "DefaultKey.txt");
		try {
	...
	public static String getDefaultFilePath() {
		...
		try {
			PrintWriter pw = new PrintWriter(defaultDir + System.getProperty("file.separator") + "DefaultKey.txt","UTF-8");
